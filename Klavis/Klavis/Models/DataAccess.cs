...
namespace Klavis.Models
{
    public class DataAccess
    {
        ...
        public async void deleteUser(string userID, string location)
        {
            try
            {
                DocumentReference checkuserRef = fireStoreDb.Collection("access").Document(location).Collection("users").Document(userID);
        ...
        public async Task<User> queryUser(string userID, string terminal)
        {
            try
            {
                DocumentReference userRef = fireStoreDb.Collection("access").Document(terminal).Collection("users").Document(userID);
